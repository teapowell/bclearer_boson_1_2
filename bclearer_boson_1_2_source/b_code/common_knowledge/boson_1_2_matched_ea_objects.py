...
@unique
class Boson12MatchedEaObjects(MatchedEaObjects):
    BOSON_NAMES = auto()

    GML_FILE_NAMES = auto()

    INSPIRE_OBJECT_NAMES = auto()

    OS_GAZETTEER_OBJECT_NAMES = auto()

    MODEL_PACKAGE = auto()

    EPSG_27700_COORDINATE_POINT_NAME_INSTANCES = auto()

    SUBTYPE_NAME_TYPE_INSTANCE = auto()

    EPSG_27700_COORDINATE_POINT_NAMES = auto()

    EPSG_27700_COORDINATE_POINTS = auto()

    EPSG_27700_EASTING_COORDINATE_LINE_NAMES = auto()

    EPSG_27700_EASTING_COORDINATE_LINES = auto()

    EPSG_27700_NORTHING_COORDINATE_LINE_NAMES = auto()

    EPSG_27700_NORTHING_COORDINATE_LINES = auto()

    EPSG_27700_COORDINATE_POINT_NAME_COMPOSED_OFS = auto()

    EPSG_27700_COORDINATE_LINE_INTERSECTIONS = auto()

    DIRECT_POSITION_POWERTYPE = auto()
    ...
    object_name = property(fget=__object_name)
