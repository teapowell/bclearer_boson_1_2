...
def get_boson_1_2_2e_h1_configuration_extend_direct_positions_type() -> UniverseModificationOperationConfigurations:
    add_dependency_to_instances_of_type_configuration_object = AddDependencyToInstancesOfTypeConfigurationObjects(
    ...
    return universe_modification_operation_configuration
