...
def get_boson_1_2_2e_e1_configuration_load_hdf5_boson() -> LoadHdf5ModelConfigurations:
...
def get_boson_1_2_2e_e1_configuration_merge_inspire_bclearer_boson() -> ContentOperationConfigurations:
