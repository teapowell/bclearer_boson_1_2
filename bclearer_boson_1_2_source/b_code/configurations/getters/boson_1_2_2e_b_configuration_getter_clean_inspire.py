...
def get_boson_1_2_2e_b_configuration_clean_inspire() -> AdjustmentOperationsSubstageConfigurations:
    convert_attributes_to_associations_adjustment_operation_configuration = AttributeToAssociationAdjustmentOperationConfigurations(
...
def __get_boson_1_2_2e_b1_configuration_load_hdf5_attributes_to_convert() -> LoadHdf5ModelConfigurations:
...
def __get_boson_1_2_2e_b2_configuration_load_hdf5_attributes_to_remove() -> LoadHdf5ModelConfigurations:
    load_hdf5_model_configuration = LoadHdf5ModelConfigurations(
        resource_namespace=ADJUSTMENT_OPERATIONS_RESOURCES_NAMESPACE,
