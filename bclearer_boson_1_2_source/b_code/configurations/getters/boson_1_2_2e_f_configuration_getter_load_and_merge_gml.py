...
def get_boson_1_2_2e_f1_configuration_load_gml_data(
    gml_data_folder_name: str,
) -> LoadGmlDataConfigurations:
    load_gml_data_configuration = LoadGmlDataConfigurations(
        gml_data_folder_path=gml_data_folder_name, short_name="2e_f1_input_cont_uni_gml"
    )

    return load_gml_data_configuration


def get_boson_1_2_2e_f1_configuration_merge_gml_data() -> ContentOperationConfigurations:
