...
def get_boson_1_2_2e_c2_configuration_load_hdf5_bclearer_individual_powersets() -> LoadHdf5ModelConfigurations:
...
def get_boson_1_2_2e_c2_configuration_merge_inspire_bclearer_individual_powersets() -> ContentOperationConfigurations:
