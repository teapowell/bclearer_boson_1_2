...
def get_boson_1_2_2e_j1_configuration_separate_standard_names_and_instances() -> ConventionShiftOperationConfigurations:
...
def get_boson_1_2_2e_j2_configuration_bespoke_standard_names_and_instances() -> ConventionShiftOperationConfigurations:
    convention_shift_operation_configuration = ConventionShiftOperationConfigurations(
