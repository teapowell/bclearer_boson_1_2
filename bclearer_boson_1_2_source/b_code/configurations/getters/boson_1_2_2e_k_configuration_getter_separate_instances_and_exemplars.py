...
def get_boson_1_2_2e_k1_configuration_separate_standard_instances_and_names() -> ConventionShiftOperationConfigurations:
    ...
    return convention_shift_operation_configuration


def get_boson_1_2_2e_k2_configuration_separate_bespoke_instances_and_names() -> ConventionShiftOperationConfigurations:
