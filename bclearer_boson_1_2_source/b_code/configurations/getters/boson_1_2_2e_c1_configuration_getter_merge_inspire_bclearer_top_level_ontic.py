...
def get_boson_1_2_2e_c1_configuration_load_hdf5_bclearer_foundation_top_level_ontic_categories() -> LoadHdf5ModelConfigurations:
    load_hdf5_model_configuration = LoadHdf5ModelConfigurations(
        resource_namespace=CONTENT_OPERATIONS_RESOURCES_NAMESPACE,
        resource_file_name=CONTENT_UNIVERSE_BCLEARER_TOP_LEVEL_ONTIC_CATEGORIES_FILENAME_HDF5,
        universe_short_name="2e_c1_input_cont_uni_bclearer_ontic",
    )

    return load_hdf5_model_configuration


def get_boson_1_2_2e_c1_configuration_merge_inspire_bclearer_top_level_ontic_categories() -> ContentOperationConfigurations:
    content_operation_configuration = ContentOperationConfigurations(
        ...
        output_universe_short_name="2e_c1_output_merge_bclearer_ontic",
