...
def get_boson_1_2_2e_h2_configuration_create_point_names() -> BespokeOperationConfigurations:
    bespoke_create_point_names_configuration_object = BespokeCreatePointNamesConfigurationObjects(
    ...
    return bespoke_operation_configuration
