...
def get_boson_1_2_2e_d1_configuration_load_hdf5_inspire_bclearer_link() -> LoadHdf5ModelConfigurations:
...
def get_boson_1_2_2e_d1_configuration_merge_inspire_bclearer_link() -> ContentOperationConfigurations:
