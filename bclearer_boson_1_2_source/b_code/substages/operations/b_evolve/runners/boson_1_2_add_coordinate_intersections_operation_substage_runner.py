...
from bclearer_boson_1_2_source.b_code.substages.operations.b_evolve.coordinate_lines.coordinate_intersections.add_coordinate_intersections_orchestrator import (
    orchestrate_add_coordinate_intersections,
)


def run_boson_1_2_add_coordinate_intersections_operation_substage(
    content_universe: NfEaComUniverses,
    ea_tools_session_manager: EaToolsSessionManagers,
    bespoke_operation_configuration: BespokeOperationConfigurations,
) -> NfEaComUniverses:
    log_message(
        message="CONTENT OPERATION: Add coordinate_intersections to universe - "
        + bespoke_operation_configuration.short_name
        + " - started"
    )

    output_universe = orchestrate_add_coordinate_intersections(
