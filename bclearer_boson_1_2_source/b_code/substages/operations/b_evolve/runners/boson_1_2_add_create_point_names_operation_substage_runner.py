...
def run_boson_1_2_create_point_names_operation_substage(
    ...
    log_message(
        ...
        + bespoke_operation_configuration.short_name
        + " - started"
    )
...
def __create_point_names(
    ...
    nf_uuid_sets_keyed_on_name_exemplars = get_nf_uuid_sets_keyed_on_name_prefix_dictionary(
    ...
    package_nf_uuid = create_root_package(
        nf_ea_com_universe=output_universe, package_name="Coordinate Points - Names"
    )

    subtype_name_type_instance_nf_uuid = get_nf_uuid_from_ea_guid_from_collection(
        nf_ea_com_universe=output_universe,
        collection_type=NfEaComCollectionTypes.EA_CLASSIFIERS,
        ea_guid=Boson12MatchedEaObjects.SUBTYPE_NAME_TYPE_INSTANCE.ea_guid,
    )

    coordinate_point_names_nf_uuid = get_nf_uuid_from_ea_guid_from_collection(
        nf_ea_com_universe=output_universe,
        collection_type=NfEaComCollectionTypes.EA_CLASSIFIERS,
        ea_guid=Boson12MatchedEaObjects.EPSG_27700_COORDINATE_POINT_NAMES.ea_guid,
    )

    name_types_instances_stereotype_nf_uuid = get_nf_uuid_from_ea_guid_from_collection(
        nf_ea_com_universe=output_universe,
...
def __create_point_name(
    ...
    new_point_name_nf_uuid = add_new_class_to_dictionary(
