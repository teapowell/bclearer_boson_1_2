...
def get_nf_uuid_sets_keyed_on_name_prefix_dictionary(
    ...
    nf_uuid_sets_keyed_on_names_dictionary = __convert_dataframe_to_dictionary(
        exemplar_and_nf_uuids_columns=exemplar_and_nf_uuids_columns
    )

    return nf_uuid_sets_keyed_on_names_dictionary
