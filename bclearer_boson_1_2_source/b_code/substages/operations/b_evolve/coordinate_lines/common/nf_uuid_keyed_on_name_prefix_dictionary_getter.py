...
def get_nf_uuid_keyed_on_name_prefix_dictionary(
    ...
    exemplar_and_nf_uuids_columns = __get_instances_of_type(
...
def __get_instances_of_type(
    ...
    instances_of_coordinate_point_type["Prefixes"] = (
        instances_of_coordinate_point_type["names"]
        .str.split()
        .str[0:prefix_word_count]
        .str.join(" ")
    )
...
def __convert_dataframe_to_dictionary(exemplar_and_nf_uuids_columns: DataFrame) -> dict:
    columns_indexed_on_exemplars = exemplar_and_nf_uuids_columns.set_index("Prefixes")

    columns_indexed_on_exemplars_dictionary = columns_indexed_on_exemplars.to_dict()

    nf_uuids_indexed_on_exemplars_dictionary = columns_indexed_on_exemplars_dictionary[
        NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name
    ]
