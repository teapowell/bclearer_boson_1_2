from bclearer_source.b_code.common_knowledge.bclearer_constants import (
    NAME_INSTANCE_ATTRIBUTE_NAME,
)
from bclearer_source.b_code.substages.operations.common.attribute_adder import (
...
def add_coordinate_line_structure_to_dictionary(
    ...
    coordinate_line_class_nf_uuid = __add_object_with_matched_type(
    ...
    coordinate_line_name_class_nf_uuid = __add_object_with_matched_type(
        new_ea_objects_dictionary=new_ea_objects_dictionary,
    ...
    return new_ea_objects_dictionary
...
def __add_object_with_matched_type(
    ...
    new_class_nf_uuid = add_new_class_to_dictionary(
...
def __add_named_by_association(
    ...
    association_nf_uuid = add_new_connector_to_dictionary(
        new_connector_dictionary=new_ea_objects_dictionary[
            NfEaComCollectionTypes.EA_CONNECTORS
        ],
...
def __add_name_instance_attribute(
    ...
    add_new_attribute_to_dictionary(
        new_ea_attributes_dictionary=new_ea_objects_dictionary[
