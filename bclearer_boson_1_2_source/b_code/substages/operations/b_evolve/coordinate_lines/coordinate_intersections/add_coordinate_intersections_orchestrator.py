...
def orchestrate_add_coordinate_intersections(
    ...
    package_nf_uuid = create_root_package(
        ...
        package_name="Coordinate Lines - Coordinate Intersections",
    )
    ...
    add_coordinate_join_association_structure(
        ...
        easting_type_matched_ea_object=Boson12MatchedEaObjects.EPSG_27700_EASTING_COORDINATE_LINES,
        northing_type_matched_ea_object=Boson12MatchedEaObjects.EPSG_27700_NORTHING_COORDINATE_LINES,
        point_type_matched_ea_object=Boson12MatchedEaObjects.EPSG_27700_COORDINATE_POINTS,
        join_association_type_matched_ea_object=Boson12MatchedEaObjects.EPSG_27700_COORDINATE_LINE_INTERSECTIONS,
    )
