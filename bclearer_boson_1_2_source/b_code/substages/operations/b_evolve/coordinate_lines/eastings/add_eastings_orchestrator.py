...
def orchestrate_add_eastings(
    ...
    eastings_exemplars = get_coordinate_line_exemplars_from_xml_test_attributes(
        nf_ea_com_universe=content_universe, dimension=CoordinateLineDimensions.EASTINGS
    )

    new_ea_objects_dictionary = create_new_ea_objects_dictionary()

    package_nf_uuid = create_root_package(
        nf_ea_com_universe=output_universe, package_name="Coordinate Lines - Eastings"
    )
