...
def convert_os_open_names_dictionary_dictionary_to_dataframe_dictionary(
    ...
    log_message(message="converting os_open_names_dictionaries to dataframes")
    ...
    ) in os_open_names_dictionary_dictionary.items():
        os_open_names_dataframe_dictionary = __add_os_open_names_dataframe(
...
def __add_os_open_names_dataframe(
    ...
    log_message(message="converting " + str(dataframe_name))

    os_open_names_dataframe = __convert_os_open_names_dictionary_to_dataframe(
        os_open_names_dictionary=os_open_names_dictionary
    )

    os_open_names_dataframe_dictionary[dataframe_name] = os_open_names_dataframe
...
def __convert_os_open_names_dictionary_to_dataframe(
    ...
    os_open_names_dataframe = DataFrame(os_open_names_dictionary)

    os_open_names_dataframe = os_open_names_dataframe.transpose()

    os_open_names_dataframe = os_open_names_dataframe.reset_index(drop=True)
