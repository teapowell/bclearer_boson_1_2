...
def append_named_place(
    os_open_names_dictionary: dict, named_place: untangle.Element, file_uuid: str
) -> dict:
    ...
    try:
        gml_bounded_by = named_place.gml_boundedBy

        os_open_names_dictionary = append_gml_envelope(
            os_open_names_dictionary=os_open_names_dictionary,
    ...
    gml_point = named_place.gn_geometry.gml_Point
