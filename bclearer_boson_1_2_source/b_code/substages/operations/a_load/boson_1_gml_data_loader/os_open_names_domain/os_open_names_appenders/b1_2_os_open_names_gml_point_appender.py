...
def append_gml_point(
    os_open_names_dictionary: dict, owning_named_place_nf_uuid: str, gml_point: Element
) -> None:
    direct_position_nf_uuid = create_new_uuid()

    gml_point_nf_uuid = create_new_uuid()

    gml_pos = gml_point.gml_pos.cdata
    ...
    srs_name = gml_point["srsName"]

    gml_id = gml_point["gml:id"]
