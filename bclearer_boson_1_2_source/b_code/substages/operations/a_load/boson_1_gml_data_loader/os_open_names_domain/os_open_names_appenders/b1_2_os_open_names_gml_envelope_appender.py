...
def append_gml_envelope(
    ...
    gml_envelope_nf_uuid = create_new_uuid()

    envelope_srs_name = gml_bounded_by.gml_Envelope["srsName"]

    envelope_lower_corner_xml_text = gml_bounded_by.gml_Envelope.gml_lowerCorner.cdata

    lower_corner_direct_position_nf_uuid = create_new_uuid()

    envelope_upper_corner_xml_text = gml_bounded_by.gml_Envelope.gml_upperCorner.cdata

    upper_corner_direct_position_nf_uuid = create_new_uuid()
