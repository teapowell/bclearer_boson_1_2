...
from bclearer_boson_1_2_source.b_code.common_knowledge.os_matched_ea_objects import (
    OsMatchedEaObjects,
)
...
def orchestrate_os_open_names_domain_to_nf_ea_com(
    ...
    gml_data_content_universe = create_empty_nf_ea_universe(
...
def __convert_domain(
    nf_ea_com_universe: NfEaComUniverses, os_open_names_dictionary: dict
) -> NfEaComUniverses:
    root_package_nf_uuid = create_root_package(
        nf_ea_com_universe=nf_ea_com_universe, package_name="GML Data Model"
    )

    nf_ea_com_universe = __convert_classifiers(
        nf_ea_com_universe=nf_ea_com_universe,
        os_open_names_dictionary=os_open_names_dictionary,
        root_package_nf_uuid=root_package_nf_uuid,
    )

    nf_ea_com_universe = __convert_connectors(
        nf_ea_com_universe=nf_ea_com_universe,
        os_open_names_dictionary=os_open_names_dictionary,
    )

    nf_ea_com_universe = __convert_attributes(
        nf_ea_com_universe=nf_ea_com_universe,
        os_open_names_dictionary=os_open_names_dictionary,
    )
...
def __convert_classifiers(
    ...
    nf_ea_com_universe = convert_to_classifiers(
        os_open_names_dictionary=os_open_names_dictionary,
        nf_ea_com_universe=nf_ea_com_universe,
...
def __convert_connectors(
    ...
    nf_ea_com_universe = convert_one_to_many_to_connectors(
        os_open_names_dictionary=os_open_names_dictionary,
        nf_ea_com_universe=nf_ea_com_universe,
        os_open_names_table_name="envelopes",
    ...
    nf_ea_com_universe.nf_ea_com_registry.dictionary_of_collections = convert_many_to_many_to_connectors(
        os_open_names_dictionary=os_open_names_dictionary,
...
def __convert_attributes(
    ...
    nf_ea_com_universe = convert_to_attributes(
        os_open_names_dictionary=os_open_names_dictionary,
        nf_ea_com_universe=nf_ea_com_universe,
