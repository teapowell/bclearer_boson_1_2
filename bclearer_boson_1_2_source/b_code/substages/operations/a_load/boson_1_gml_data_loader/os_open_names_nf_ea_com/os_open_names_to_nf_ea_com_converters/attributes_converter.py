...
def __create_new_ea_attributes(
    ...
    if matched_classifying_ea_classifier is None:
        classifying_ea_classifier_id = 0

        classifying_ea_classifier_name = "CharacterString"
        ...
        classifying_ea_classifier_id = ea_classifiers.at[
            ...
            .eq(matched_classifying_ea_classifier.ea_guid)
            .idxmax(),
            NfColumnTypes.NF_UUIDS.column_name,
        ]

        classifying_ea_classifier_name = None
