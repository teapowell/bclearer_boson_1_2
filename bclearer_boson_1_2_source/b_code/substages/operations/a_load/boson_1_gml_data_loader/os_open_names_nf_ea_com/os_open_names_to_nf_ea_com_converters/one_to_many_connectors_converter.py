...
def __create_new_ea_connectors(
    os_open_names: DataFrame, connector_name: str, connector_type: str
) -> DataFrame:
    filter_and_rename_dictionary = {
        "owning_nf_uuids": NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name,
        NfColumnTypes.NF_UUIDS.column_name: NfEaComColumnTypes.ELEMENTS_CLIENT_PLACE2_END_CONNECTORS.column_name,
    }
