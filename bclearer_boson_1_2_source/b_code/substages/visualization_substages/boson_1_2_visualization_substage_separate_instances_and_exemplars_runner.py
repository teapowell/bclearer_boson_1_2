...
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_k_configuration_getter_separate_instances_and_exemplars import (
    get_boson_1_2_2e_k1_configuration_separate_standard_instances_and_names,
)
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_k_configuration_getter_separate_instances_and_exemplars import (
    get_boson_1_2_2e_k2_configuration_separate_bespoke_instances_and_names,
)
...
def run_visualization_substage_separate_instances_and_exemplars(
    ...
    return separated_bespoke_instances_and_exemplars_universe
...
def __separate_standard_instances_and_exemplars(
    ...
    separated_standard_instances_and_exemplars_universe = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe,
        convention_shift_operation_configuration=get_boson_1_2_2e_k1_configuration_separate_standard_instances_and_names(),
    )
    ...
    return separated_standard_instances_and_exemplars_universe
...
def __separate_bespoke_instances_and_exemplars(
    ...
    separated_bespoke_instances_and_exemplars = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe,
        convention_shift_operation_configuration=get_boson_1_2_2e_k2_configuration_separate_bespoke_instances_and_names(),
    )
    ...
    return separated_bespoke_instances_and_exemplars
