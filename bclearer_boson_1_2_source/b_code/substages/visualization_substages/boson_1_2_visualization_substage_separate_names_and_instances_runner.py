...
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_j_configuration_getter_separate_names_and_instances import (
    get_boson_1_2_2e_j1_configuration_separate_standard_names_and_instances,
)
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_j_configuration_getter_separate_names_and_instances import (
    get_boson_1_2_2e_j2_configuration_bespoke_standard_names_and_instances,
)
...
def __separate_standard_names_and_instances(
    ...
    separated_standard_names_and_instances_universe = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe,
        convention_shift_operation_configuration=get_boson_1_2_2e_j1_configuration_separate_standard_names_and_instances(),
    )
...
def __separate_bespoke_names_and_instances(
    ...
    separated_bespoke_names_and_instances = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe,
        convention_shift_operation_configuration=get_boson_1_2_2e_j2_configuration_bespoke_standard_names_and_instances(),
    )
