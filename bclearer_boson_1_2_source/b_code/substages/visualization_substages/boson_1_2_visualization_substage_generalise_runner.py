...
def run_visualization_substage_generalise(
    ...
    os_inspire_merged_bclearer_top_level_ontic_categories_universe = run_merge_hdf5_model_content_operations_substage(
    ...
    os_inspire_merged_bclearer_individual_powerset_component_universe = run_merge_hdf5_model_content_operations_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    os_inspire_merged_bclearer_naming_pattern_component_universe = run_merge_hdf5_model_content_operations_substage(
        ea_tools_session_manager=ea_tools_session_manager,
