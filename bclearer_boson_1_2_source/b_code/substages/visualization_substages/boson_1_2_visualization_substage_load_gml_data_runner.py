...
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_f_configuration_getter_load_and_merge_gml import (
    get_boson_1_2_2e_f1_configuration_load_gml_data,
)
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_g_configuration_getter_objects_to_classes import (
    get_boson_1_2_2e_g1_configuration_objects_to_classes,
)
from bclearer_boson_1_2_source.b_code.substages.operations.b_evolve.runners.boson_1_merge_gml_data_content_operations_substage_runner import (
...
def run_visualization_substage_load_gml_data(
    ...
    load_gml_data_configuration = get_boson_1_2_2e_f1_configuration_load_gml_data(
    ...
    content_universe_objects_shifted_to_classes_universe = run_convention_shift_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
        content_universe=content_universe_merged_gml_data_universe,
        convention_shift_operation_configuration=get_boson_1_2_2e_g1_configuration_objects_to_classes(),
    )
    ...
    return content_universe_objects_shifted_to_classes_universe
