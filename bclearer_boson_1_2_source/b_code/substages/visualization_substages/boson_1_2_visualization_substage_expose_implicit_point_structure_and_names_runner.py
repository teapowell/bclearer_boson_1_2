...
def run_visualization_substage_expose_implicit_point_structure_and_names(
    ...
    direct_positions_extended_type_universe = run_universe_modification_operations_substage(
    ...
    point_names_created_universe = run_boson_1_2_create_point_names_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    points_de_duplicated_universe = run_boson_1_2_de_duplicate_points_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    exposed_implicit_point_structure_and_names_universe = run_boson_1_2_link_points_and_point_names_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    return exposed_implicit_point_structure_and_names_universe
