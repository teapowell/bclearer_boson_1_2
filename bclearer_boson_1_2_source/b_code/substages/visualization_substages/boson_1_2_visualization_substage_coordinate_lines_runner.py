...
def run_visualization_substage_coordinate_names(
    ...
    coordinate_intersections_added_universe = run_boson_1_2_add_coordinate_intersections_operation_substage(
        ea_tools_session_manager=ea_tools_session_manager,
    ...
    return coordinate_intersections_added_universe
