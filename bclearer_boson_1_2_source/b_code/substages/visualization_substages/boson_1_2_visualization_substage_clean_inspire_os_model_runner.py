from bclearer_source.b_code.substages.operations.b_evolve.adjustment_operations.runners.adjustment_operations_substage_runner import (
...
from bclearer_boson_1_2_source.b_code.configurations.getters.boson_1_2_2e_b_configuration_getter_clean_inspire import (
    get_boson_1_2_2e_b_configuration_clean_inspire,
)
...
def run_visualization_substage_clean_inspire_os_model(
    ...
    os_inspire_filtered_universe = run_adjustment_operations_substage(
        ...
        adjustment_operations_substage_configuration=get_boson_1_2_2e_b_configuration_clean_inspire(),
    )
