...
def orchestrate_boson_1_2_evolve_stage(
    ...
    os_inspire_filtered_universe = run_visualization_substage_clean_inspire_os_model(
        ea_tools_session_manager=ea_tools_session_manager,
        output_folder_name=output_folder_name,
        content_universe=content_universe,
    )

    generalised_names_universe = run_visualization_substage_generalise(
        ea_tools_session_manager=ea_tools_session_manager,
        output_folder_name=output_folder_name,
        content_universe=os_inspire_filtered_universe,
    )

    added_gml_data_universe = run_visualization_substage_load_gml_data(
        ea_tools_session_manager=ea_tools_session_manager,
        output_folder_name=output_folder_name,
    ...
    exposed_coordinate_names_universe = run_visualization_substage_coordinate_names(
        ea_tools_session_manager=ea_tools_session_manager,
        output_folder_name=output_folder_name,
    ...
    return semantically_grounded_output_universe
